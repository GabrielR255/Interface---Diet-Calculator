...
<head>
    ...
    <title>Calculo de Proteina</title>
</head>
    ...
    <div class="Home-box">
        ...
        <div class="container">
            ...
            <center>
                ...
                <div titulo>
                    <h1 id="title">Ingestão - Proteinas</h1>
                </div>
            </center>
            ...
            <center>
            <div class="blocolink">
                <a class="alinks" href="proteina info.php">Mais informações</a>
            </div>
        </center>
            <center>
                <div id="informações">
                    <div id="result" class="apagar">
                        <div id="bmi">
                            <span id="value"></span>
                            <span id="protein-on">Total de proteinas diárias</span>
                        </div>
