...
<head>
    ...
    <link rel="stylesheet" href="tmbman.css">
...
<?php include 'header.php'; ?>
    ...
    <div class="Home-box">
        <div class="img-home">
            <img src="tmb man.svg" alt="tmbman">
        </div>
        <div class="container">
            <form id="form">
        ...
        <center>
            <div class="blocolink">
                <a class="alinks" href="Mais informações sobre (TMB).php">Mais informações sobre (TMB)</a>
            </div>
        </center>
