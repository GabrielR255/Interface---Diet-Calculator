...
<head>
    ...
    <link rel="stylesheet" href="gordura.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css">    
    <title>Calculo de Gordura</title>
</head>
    ...
    <div class="Home-box">
        ...
        <div class="container">
            ...
            <center>
                ...
                <div titulo>
                    <h1 id="title">Ingestão - Gordura</h1>
                </div>
            </center>
            ...
            <center>
            <div class="blocolink">
                <a class="alinks" href="gordura info.php">Mais informações</a>
            </div>
        </center>
            <center>
                <div id="informações">
                    <div id="result" class="apagar">
                        <div id="bmi">
                            <span id="value"></span>
                            <span id="fat-on">Total de gordura diária</span>
                        </div>
